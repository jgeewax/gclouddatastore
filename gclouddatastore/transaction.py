...
class Transaction(object):
  ...
  .. warning::
    ...
    :func:`gclouddatastore.entity.Entity.save`
    rather than using
    :func:`gclouddatastore.connection.Connection.save_entity` directly.
  ...
  def mutation(self):
    ...
    :rtype: :class:`gclouddatastore.datastore_v1_pb2.Mutation`
